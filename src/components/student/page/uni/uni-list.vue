        ...
        <div class="row mt-2">
          <div class="col-12 menu-tab">
            <button
              ...
              :class="
                tab == '' || tab == 'shortlisted' ? 'btn-type-1' : 'btn-type-2'
              "
              @click="changeTab('shortlisted')"
            >
              Shortlisted

              <div class="badge bg-primary ms-2" v-if="summary.shortlisted > 0">
                {{ summary.shortlisted }}
              </div>
            </button>
            <button
            ...
            >
              Waitlisted
              <div class="badge bg-primary ms-2" v-if="summary.waitlisted > 0">
                {{ summary.waitlisted }}
              </div>
            </button>
          </div>
          ...
          <div class="col mb-3" v-for="i in uniList" :key="i">
            ...
            >
              <div class="uni-icon ps-1 text-start">
                ...
                ></i>
                <i class="fa-solid fa-paper-plane" v-if="tab == 'applied'"></i>
                <i
