  ...
  <div id="webinar">
    <div class="container mt-4">
      ...
      <div
        class=""
        v-if="
          (menu.menu == 'webinar' || menu.menu == 'my-activity') &&
          menu.submenu == ''
        "
      >
        <div class="row">
      ...
      <div class="row mt-4">
        <div class="col">
          <v-view
            :menu="menu"
            v-if="menu.menu == 'webinar' && menu.submenu != ''"
          ></v-view>
        </div>
      </div>
    </div>
...
<script>
import View from "@/components/student/page/webinar-detail/view";
...
export default {
  ...
  methods: {
    webinar(i) {
      this.$router.push({ path: "/user/webinar/career/" + i });
    },
  },
  watch: {
    $route(to) {
