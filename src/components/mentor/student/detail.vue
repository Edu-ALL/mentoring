...
export default {
  ...
  methods: {
    getData(email) {
      this.$alert.loading();
      this.$axios
        .get(this.$url + "student/detail?mail=" + email, {
          headers: {
    ...
    get1on1(email) {
      this.$alert.loading();
      this.$axios
        .get(this.$url + "activities/1-on-1-call?mail" + email, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
        })
    ...
    getWebinar(email) {
      this.$alert.loading();
      this.$axios
        .get(this.$url + "activities/webinar?mail=" + email, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
        })
    ...
    getEvent(email) {
      this.$alert.loading();
      this.$axios
        .get(this.$url + "activities/event?mail=" + email, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
        })
    ...
    getFiles(email) {
      this.$alert.loading();
      this.$axios
        .get(this.$url + "student/files?mail=" + email, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
        })
