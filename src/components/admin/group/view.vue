...
import Meeting from "@/components/admin/group/view-detail/meeting";
import Member from "@/components/admin/group/view-detail/member";
...
export default {
    ...
    async getData() {
      try {
        const response = await this.$axios.get(
          "mentor/detail/group/project/" + this.groupId
        );
  ...
  created() {
    this.groupId = this.$route.params.submenu;
    this.getData();
  },
};
</script>
