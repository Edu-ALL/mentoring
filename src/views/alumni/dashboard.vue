...
<script>
import Navbar from "@/components/layout/alumni/navbar";

import Home from "@/views/alumni/page/home";
import Activity from "@/views/alumni/page/activity";
