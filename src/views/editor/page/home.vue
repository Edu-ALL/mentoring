          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-4 text-center">
                <vue-feather type="book-open" class="h-ico"></vue-feather>
              </div>
              <div class="col-8">
                <div class="h-count">21</div>
                <div class="h-label">Essay Total</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <table class="table table-borderless">
            <tbody>
              <tr class="align-middle" v-for="i in 3" :key="i">
                ...
                <td class="text-end">
                  <button class="btn btn-sm btn-alumni btn-type-1 m-0 py-1">
                    Result
                  </button>
                </td>
              </tr>
